...
CBD_23708_1930a_vid3820725_V12
...
<article style="position:fixed;top:`+(FonteSizeStandard__*1.625)+`rem;right:0rem;border:solid 0.00rem green;">
	...
	<aside onclick="InformazioniConfigurazioneApri()"  style="width:auto;height:`+(FonteSizeStandard__*(1.250-0.000))+`rem;background-color:white;color:orange;font-size:`+(FonteSizeStandard__*(1.250-0.000))+`rem;border-radius:0.5rem;cursor:pointer;">
	...
	<article id="InformazioniConfigurazioneBox__" class="da_mo__" style="position:fixed;top:`+(FonteSizeStandard__*3.00)+`rem; height:75%;border: solid 0.15rem red;display:none;overflow:auto;">

<aside class="configurazione_item__">
<!--	<i class="bi bi-info-circle-fill"></i>  -->
<i onclick="InformazioniConfigurazioneChiudi()" class="bi bi-x-circle-fill"></i>
</aside>
...
function InformazioniConfigurazione(){
...
function AppUpdated(arg0__){ 
	...
	<div style="color:green;font-size:`+FonteAppUpdated__+`rem;">&#61;CBD_23708_1930a_vid3820725_V12&#61;</div>`; 
